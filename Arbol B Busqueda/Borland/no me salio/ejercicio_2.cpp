...
short nodos=0;
    ...
    void Mostrar_arbol(Nodo* arbol, short contador)       //Funcion que hace la operacion de imprimir arbol horizontalmente
	{
		...
		else
		{
			...
			Mostrar_arbol(arbol->izquierda, contador+0);
			Mostrar_arbol(arbol->derecha, contador+0);
...
void Menu()
{
  ...
  do
  {
    ...
    gotoxy(70,1);
    cout<<"* Practica 7 Arbol BB  (Nodos) *";
	...
	switch(option)
	{
		...
		case 2 :	
					...
					Mostrar_arbol(primer_nodo, cont);
					
					gotoxy(4,25);
					cout<<"Arbol Binario de Busqueda con : "<<nodos<<" nodos "; 
